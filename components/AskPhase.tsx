...
const RUNAWAY_PHRASES = [
  ...
  "🆘 Permission denied.",
  "Dream on, Adam 😴",
  "Unauthorized negativity detected.",
  ...
  "This feature has been removed in version 2026.",
  "Constraint violation: Valentine must be YES.",
  "Not so fast, Adam ",
  "Oh really, Adam? 🤨",
  "Adam… that hurt a little 💔",
  "Think again, Adam 🤔",
  "🥷🏼 Adjusting Adam’s decision...",
  "Nooo Adam 🥺",
  "false is not an acceptable value.",
  "2000 push ups!!! 🏋️‍♂️",
  "Not today, Adam 🫶🏻",
  ...
  "'No' is deprecated.",
  "Wrong button, Adam! 🚫",
  "Your click has been overridden.",
  "Adam, be nice! 🌸",
